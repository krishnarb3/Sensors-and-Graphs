...
public class gyrosensor extends ActionBarActivity implements SensorEventListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        graphSeries.setColor(Color.YELLOW);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_gyrosensor, menu);
        return true;
    }
